...
public class InitializedData {
    ...
    @Inject
    public InitializedData(RequestContextController requestContextController, RestaurantService restaurantService, UserService userService, DishService dishService){
